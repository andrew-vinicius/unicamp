...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { file: @equipment.file, name: @equipment.name, qrcode: @equipment.qrcode, slots: @equipment.slots, youtube: @equipment.youtube } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { file: @equipment.file, name: @equipment.name, qrcode: @equipment.qrcode, slots: @equipment.slots, youtube: @equipment.youtube } }
